...
export class BirthdayResult extends LitElement {
  ...
  <g id="body" transform="translate(0,100),scale(2.3)">
        ...
        >
          ...
          <g clip-path="url(#clip-2)">
            <path
              ...
              fill=""
              stroke="rgb(${BirthdayStore.socialColorResult})"
        ...
        <g opacity="1" transform="matrix(1, 0, 0, 1, -10.594479, 199.195526)">
          ...
          <g clip-path="url(#m)" visibility="${
            ...
            opacity="0.5"
              ...
              stroke-linejoin="round"
              fill="none"
              stroke="rgb(${BirthdayStore.lostColorResult})"
        ...
        >
          ...
          <g clip-path="url(#u)">
            <path
              ...
              stroke-linejoin="round"
              fill="none"
              stroke="rgb(${BirthdayStore.bodyColorResult})"
      ...
      />
      <path
        visibility="${BirthdayStore.shape == "triangle" ? "visible" : "hidden"}"
      ...
      <rect
        visibility="${BirthdayStore.shape == "diamond" ? "visible" : "hidden"}"
        x="122"
        y="83"
        width="115"
        height="115"
      ...
      <path
        visibility="${BirthdayStore.shape == "pentagon" ? "visible" : "hidden"}"
        style="fill: rgb(${
          BirthdayStore.avgcolor
        }); stroke: rgb(0, 0, 0); stroke-opacity: 0.5;"
      ...
      <path
        visibility="${BirthdayStore.shape == "hexagon" ? "visible" : "hidden"}"
        style="fill: rgb(${
          BirthdayStore.avgcolor
        }); stroke: rgb(0, 0, 0); stroke-opacity: 0.5;"
      ...
      />
      <g
        visibility="${BirthdayStore.emoji == "happy" ? "visible" : "hidden"}"
        stroke="null"
        id="Layer_1"
      ...
      <g
        visibility="${BirthdayStore.emoji == "quite" ? "visible" : "hidden"}"
        stroke="null"
        id="Layer_1"
        transform="matrix(1, 0, 0, 1, 127.418594, 147.348846)"
      >
   ...
   <g id="body_png_group">
        <image x="5" y="183" width="68" height="35" href="../../assets/titles/physical.png" />
        <image x="35" y="95" width="58" height="35" href="../../assets/titles/mental.png" />
        <image x="225" y="195"  width="68" height="38" href="../../assets/titles/work.png" />
        <image x="206" y="85" width="62" height="32" href="../../assets/titles/social.png" /> 
        <image visibility="${
          BirthdayStore.lost == true ? "visible" : "hidden"
